...
function OpportunitiesBoard({ opportunities, lang, onOpenModal }) {
  ...
  const filtered = opportunities.filter(o => {
    ...
    if (q && !o.title.includes(q) && !o.titleAr.includes(q) &&
        !o.description.includes(q) && !o.city.includes(q))  return false;
    return true;
  });
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-6">
        ...
        <div className="flex justify-end mt-3">
          <button
            onClick={() => { setSearchText(''); setFilterCity(''); setFilterCat('');
              setFilterType(''); setFilterScope(''); setFilterAge(''); }}
