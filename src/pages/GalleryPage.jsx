...
const GALLERY_ITEMS = [
  {
    id: 1,
    src: '/gallery/youth-football-training.jpg',
    captionHe: 'אימון כדורגל קהילתי',
    captionAr: 'تدريب كرة القدم المجتمعي',
    tag: 'sport',
    tagLabelHe: 'ספורט',
    tagLabelAr: 'رياضة',
  ...
  {
    id: 2,
    src: '/gallery/youth-art-workshop.jpg',
    captionHe: 'סדנת ציור ויצירה',
    captionAr: 'ورشة الرسم والإبداع',
    tag: 'art',
    tagLabelHe: 'אמנות',
    tagLabelAr: 'فنون',
  ...
  {
    id: 3,
    src: '/gallery/community-garden-volunteering.jpg',
    captionHe: 'פעילות התנדבות בגינה הקהילתית',
    captionAr: 'نشاط التطوع في الحديقة المجتمعية',
    tag: 'volunteer',
    tagLabelHe: 'התנדבות',
    tagLabelAr: 'تطוع',
  ...
  {
    id: 4,
    src: '/gallery/youth-science-learning.jpg',
    captionHe: 'מעבדת מדע לנוער',
    captionAr: 'مختبر العلوم للشباب',
    tag: 'science',
    tagLabelHe: 'מדע',
    tagLabelAr: 'علوم',
  ...
  {
    id: 5,
    src: '/gallery/community-event-gathering.jpg',
    captionHe: 'אירוע קהילתי שנתי',
    captionAr: 'الحدث المجتمعي السنوي',
    tag: 'community',
    tagLabelHe: 'קהילה',
    tagLabelAr: 'مجتمع',
  ...
  {
    id: 6,
    src: '/gallery/youth-basketball-tournament.jpg',
    captionHe: 'טורניר כדורסל בין-ישובי',
    captionAr: 'بطولة كرة السلة بين البلدات',
    tag: 'sport',
    tagLabelHe: 'ספורט',
    tagLabelAr: 'رياضة',
    tagColor: 'bg-orange-500',
  ...
  {
    id: 7,
    src: '/gallery/music-workshop-drums.jpg',
    captionHe: 'סדנת מוזיקה ותופים',
    captionAr: 'ورشة الموسيقى والطبل',
    tag: 'art',
    tagLabelHe: 'אמנות',
    tagLabelAr: 'فنون',
    tagColor: 'bg-violet-500',
  ...
  {
    id: 8,
    src: '/gallery/community-cleanup-volunteers.jpg',
    captionHe: 'ניקוי פארק קהילתי',
    captionAr: 'تنظيف الحديقة المجتمعية',
    tag: 'volunteer',
    tagLabelHe: 'התנדבות',
    tagLabelAr: 'تطوع',
    tagColor: 'bg-emerald-500',
  ...
  {
    id: 9,
    src: '/gallery/youth-coding-workshop.jpg',
    captionHe: 'קורס קידוד ותכנות לנוער',
    captionAr: 'دورة البرمجة للشباب',
    tag: 'science',
    tagLabelHe: 'טכנולוגיה',
    tagLabelAr: 'تكنולוגيا',
    tagColor: 'bg-blue-500',
  },
  {
    id: 10,
    src: '/gallery/youth-festival-celebration.jpg',
    captionHe: 'פסטיבל נוער אזורי',
    captionAr: 'مهرجان الشباب الإقليمي',
    tag: 'community',
    tagLabelHe: 'אירוע',
    tagLabelAr: 'حدث',
    tagColor: 'bg-pink-500',
  ...
  {
    id: 11,
    src: '/gallery/youth-dance-performance.jpg',
    captionHe: 'הצגת מחול סיום שנה',
    captionAr: 'عرض الرقص في نهاية السنة',
    tag: 'art',
    tagLabelHe: 'אמנות',
    tagLabelAr: 'فנون',
    tagColor: 'bg-violet-500',
  ...
  {
    id: 12,
    src: '/gallery/nature-hiking-group.jpg',
    captionHe: 'טיול שנתי לטבע הגליל',
    captionAr: 'رحلة سنوية إلى طبيعة الجليل',
    tag: 'community',
    tagLabelHe: 'פעילות',
    tagLabelAr: 'نشاط',
    tagColor: 'bg-pink-500',
      ...
      <div className="relative overflow-hidden bg-gradient-to-bl from-cyan-600 via-teal-500 to-emerald-500 text-white">
        ...
        <div className="relative max-w-4xl mx-auto px-4 py-12 sm:py-20 text-center">
          <div className="inline-flex items-center gap-2 mb-4 px-4 py-1.5 bg-white/20 backdrop-blur-sm rounded-full text-xs font-semibold border border-white/30">
            <span>📸</span>
            <span>{isAr ? 'معرض الصور' : 'גלריית התמונות'}</span>
          </div>

          <h1 className="text-3xl sm:text-5xl font-black mb-3 leading-tight">
            {isAr ? 'لحظاتنا المميزة' : 'הרגעים שלנו'}
          </h1>
        ...
        {filtered.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-xl font-bold text-gray-500">
              {isAr ? 'لا توجد صور في هذا القسم' : 'אין תמונות בקטגוריה זו'}
            </p>
          </div>
        )}
